...
%         w(i,:)=Temp
    ...
    InitSat=0;
    AreaBC=200; %姣忎釜BC鍗曞厓200銕?
    WidthBC=10;
    AreaPP=150; %姣忎釜PP鍗曞厓150銕?
    WidthPP=10;
    ...
    %          Areaperv=(1-imperv*0.01)*Area*10000;%渗透部分面积
        if dinp(1,65*2+i*2)==0 && dinp(1,65*2+i*2-1)==0 %00 0%
           LIDSizeBC=0;
        elseif dinp(1,65*2+i*2)==1 && dinp(1,65*2+i*2-1)==0 %01 3.33%
           LIDSizeBC=Area*5/3;
        elseif dinp(1,65*2+i*2)==0 && dinp(1,65*2+i*2-1)==1 %10 6.67%
           LIDSizeBC=Area*5*2/3;
        elseif dinp(1,65*2+i*2)==1 && dinp(1,65*2+i*2-1)==1 %11 10%
           LIDSizeBC=Area*5;
        end
        if dinp(1,65*2+18+18+i*2)==0 && dinp(1,65*2+18+18+i*2-1)==0 %00 0%
           LIDSizePP=0;
        elseif dinp(1,65*2+18+18+i*2)==1 && dinp(1,65*2+18+18+i*2-1)==0 %01 3.33%
           LIDSizePP=Area*20/3/3;
        elseif dinp(1,65*2+18+18+i*2)==0 && dinp(1,65*2+18+18+i*2-1)==1 %10 6.67%
           LIDSizePP=Area*20/3*2/3;
        elseif dinp(1,65*2+18+18+i*2)==1 && dinp(1,65*2+18+18+i*2-1)==1 %11 10%
           LIDSizePP=Area*20/3;
        end
        if LIDSizeBC~=0 || LIDSizePP~=0
             ...
             if nBC*AreaBC+nPP*AreaPP>Area*1000 %如果加起来大于10%，按10%乘以BCPP比例
                 nBC=round((Area*1000*BCbili)/AreaBC);
                 nPP=round((Area*1000*PPbili)/AreaPP);
                 BCbili=AreaBC*nBC/(AreaBC*nBC+AreaPP*nPP);
                 PPbili=AreaPP*nPP/(AreaBC*nBC+AreaPP*nPP);
             end
